...
export function DtxReminders() {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-4 p-4">
      <div className="rounded-2xl border bg-card/80 p-4 shadow-sm backdrop-blur-xl dark:bg-card/60">
      ...
      <Card className="border-0 shadow-sm">
        ...
        <CardContent className="space-y-3">
          ...
          <div className="space-y-3">
            {items.length ? (
              items.map((it) => (
                <div key={it.id} className="space-y-2 rounded-xl border bg-card p-3 dark:bg-card/50">
