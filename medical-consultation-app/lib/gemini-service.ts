...
export class GeminiService {
  ...
  async generateAgent(opts: {
    ...
    const system = [
      ...
      '```json',
      '{',
      '  "response": "1. Giải thích + 2. Câu hỏi theo dõi",',
      '  "suggested_investigation": "Câu hỏi tiếp theo nếu user muốn khám phá thêm",',
      '  "actions": [',
      '    { "type": "ask_navigation", "args": { "feature": "tra-cuu", "reason": "Để tra cứu chi tiết..." } }',
      '  ]',
      '}',
      '```',
      '',
