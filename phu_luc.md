...
## B.3. Các script đánh giá tự động hệ thống (AIIDE System Scripts)
...
| **Giai đoạn 3** | Viết các script đánh giá tự động (AIIDE) và chạy thực nghiệm định lượng / định tính. | Tuần 7-9 | Cao Nguyễn Thành An | Báo cáo `routing_analysis`, `ab_report` |
