...
Kết quả tổng hợp điểm số trung bình của 20 ca lâm sàng và thời gian phản hồi giữa hai kiến trúc được trình bày chi tiết tại Bảng 5.7.

##### Bảng 5.7: Bảng so sánh hiệu năng định tính và độ trễ giữa Vector RAG và GraphRAG
...
Kết quả Bảng 5.7 cho thấy GraphRAG đạt tỷ lệ thắng **100.0%** (20/20 ca thắng thế, không có ca hòa hay thua) khi chấm điểm tự động. Mức tăng điểm chất lượng y khoa vượt trội, đặc biệt là ở khía cạnh Khả năng giải thích cơ sở y khoa (+1.40 điểm) và Tính chính xác y khoa (+1.30 điểm).
