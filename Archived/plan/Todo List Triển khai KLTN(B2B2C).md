...
* \[ \] 🤖 **\[AI IDE\]** Refactor FastAPI: Tích hợp google-generativeai. Cấu hình .env chứa GEMINI\_API\_KEY.  
...
* \[ \] 🤖 **\[AI IDE\]** Tích hợp Vector Search \+ Graph Search \-\> Tạo Tool Python search\_medical\_graph.  
...
* \[ \] 🤖 **\[AI IDE\]** Cấu hình Google Calendar API làm Tool book\_appointment.  
