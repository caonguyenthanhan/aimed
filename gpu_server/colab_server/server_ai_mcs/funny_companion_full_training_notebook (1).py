...
# @title CELL 4 — TOKENIZER
tokenizer = AutoTokenizer.from_pretrained(MODEL_NAME)
tokenizer.pad_token = tokenizer.eos_token
tokenizer.model_max_length = 1024

# @title CELL 5 — FORMAT CHAT
...
def formatting_prompts_func(example):
    return {
        "text": tokenizer.apply_chat_template(
            example["messages"],
            tokenize=False,
            add_generation_prompt=True   # 🔴 ĐỔI THÀNH TRUE
        )
    }
...
# @title CELL TEST — CHAT TEMPLATE (FINAL, ĐÚNG 100%)

messages = [
    {
        "role": "system",
        "content": "Bạn là một người bạn thân, nói chuyện tự nhiên, không dạy đời."
    },
    {
        "role": "user",
...
# @title CELL 12 — UPLOAD LORA TO HUGGING FACE
...
REPO_ID = "An-CNT/doctorai-tamly-lora"  # 🔴 ĐỔI THÀNH REPO CỦA BẠN
...
print("✅ Đã upload LoRA lên Hugging Face:", REPO_ID)